  ...
  return (
    <div className="h-[100dvh] flex relative overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-12 bg-background relative h-[100dvh] overflow-hidden" style={{ paddingTop: 'max(env(safe-area-inset-top, 20px), 20px)', paddingBottom: 'max(env(safe-area-inset-bottom, 16px), 16px)' }}>
        ...
        <div className="w-full max-w-[420px] relative z-10 flex flex-col items-center h-full justify-center gap-0">
          {/* Top: Mobile logo */}
          <div className={`lg:hidden text-center ${registerMode ? 'mb-2' : 'mb-4'} animate-[fadeSlideUp_0.6s_ease-out_both] shrink-0`}>
            <div className="inline-flex items-center justify-center w-20 h-20 bg-primary/10 rounded-2xl mb-2 border border-primary/20 shadow-lg shadow-primary/10">
              <img src={clubLogo} alt="FCO Logo" className="w-[4.5rem] h-[4.5rem] object-contain" />
            </div>
