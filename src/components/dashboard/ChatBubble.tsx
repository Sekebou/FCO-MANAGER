...
const ChatBubble: React.FC<Props> = ({ currentUser, members, chatOpen, setChatOpen }) => {
  ...
  if (!chatOpen) {
    return (
      <div className="fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] left-3 sm:left-auto sm:right-6 z-[60]">
  ...
  return (
    <div className="fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] left-3 sm:left-auto sm:right-6 z-[60] flex flex-col items-start sm:items-end gap-3">
