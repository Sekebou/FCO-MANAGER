...
function getPositionCoords(bounds: SafeBounds): Record<string, { x: number; y: number }> {
  ...
  return {
    'Attaquant': { x: cx, y: 2 },
    'Ailier gauche': { x: bounds.left, y: 6 },
    'Ailier droit': { x: bounds.right, y: 6 },
    'Milieu offensif': { x: cx, y: 26 },
    'Milieu central': { x: cx, y: 37 },
    'Milieu gauche': { x: bounds.left, y: 37 },
    'Milieu droit': { x: bounds.right, y: 37 },
    'Milieu défensif': { x: cx, y: 48 },
    'Latéral gauche': { x: bounds.left - 2, y: 68 },
    'Latéral droit': { x: bounds.right + 2, y: 68 },
