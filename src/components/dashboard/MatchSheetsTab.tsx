...
import { Search, Trophy, Calendar, Clock, MapPin, ChevronDown, ChevronUp, Users, Shield, Lock, Trash2, RefreshCw, X, UserPlus, AlertTriangle, Bell, Hash, Check } from 'lucide-react';
...
const MatchSheetsTab: React.FC<Props> = ({ matchSheets, players, isManager = false, championships = [], teamLogoMap = {}, currentUser, onMatchSheetUpdated, onDeleteMatchSheet, onEventConvocationsUpdated }) => {
  ...
  // Sélection joueur inscrit (étape numéro)
  const [listSelectedPlayer, setListSelectedPlayer] = useState<{ id: string; name: string } | null>(null);
